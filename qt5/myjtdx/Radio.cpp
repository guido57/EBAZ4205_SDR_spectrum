...
//    QRegularExpression valid_callsign_regexp {R"(\d[[:alpha:]]|[[:alpha:]]\d)"};
  ...
  {
//GGif ((!callsign.at(1).isDigit() && callsign.size () == 2     ) || callsign == "F" || callsign == "G" || callsign == "I" || callsign == "K" || callsign == "W") {
    if ((callsign.size () == 2     && !callsign.at(1).isDigit() ) || callsign == "F" || callsign == "G" || callsign == "I" || callsign == "K" || callsign == "W") {
