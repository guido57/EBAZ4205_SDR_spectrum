...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_CAPTURE_DATA_BYTES" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_CAPTURE_NUM_WORDS_EXP2" -parent ${Page_0}
  ...
  ipgui::add_param $IPINST -name "C_IGNORE_VALID" -parent ${Page_0}
