...
HD_PWD='/home/guido/GitHub/EBAZ4205_SDR_spectrum/IP_axis2c/project_1/project_1.runs/design_1_myclkgen_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_myclkgen_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_myclkgen_0_1.tcl
