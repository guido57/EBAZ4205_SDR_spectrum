...
module decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix(data_in, valid_in, resetn, serial_clock_in, 
  serial_data_out, serial_clock_out, fq_ud_out)
/* synthesis syn_black_box black_box_pad_pin="data_in[39:0],valid_in,resetn,serial_clock_in,serial_data_out,serial_clock_out,fq_ud_out" */;
  input [39:0]data_in;
  input valid_in;
  input resetn;
