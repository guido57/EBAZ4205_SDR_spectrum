...
#
# Generated by Vivado on Sun Aug 13 10:19:11 CEST 2023
...
# Design libraries
design_libs=(xil_defaultlib sim_rst_gen_v1_0_2 xlconstant_v1_1_7)
...
compile()
{
  ...
  vlogan -work sim_rst_gen_v1_0_2 $vlogan_opts +v2k \
    "$ref_dir/../../../../axi_gen_test.gen/sources_1/bd/design_1/ipshared/c56d/hdl/sim_rst_gen_v1_0_vl_rfs.v" \
  2>&1 | tee -a vlogan.log
  ...
  vlogan -work xlconstant_v1_1_7 $vlogan_opts +v2k \
    "$ref_dir/../../../../axi_gen_test.gen/sources_1/bd/design_1/ipshared/badb/hdl/xlconstant_v1_1_vl_rfs.v" \
  2>&1 | tee -a vlogan.log
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/guido/Github/EBAZ4205_SDR_spectrum/axi_gen_test/axi_gen_test.cache/compile_simlib/vcs"
  fi
