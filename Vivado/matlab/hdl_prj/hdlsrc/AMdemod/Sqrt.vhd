-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\AMdemod\Sqrt.vhd
...
-- 
-- Module: Sqrt
-- Source Path: AMdemod/AM demodulator/Sqrt
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ARCHITECTURE rtl OF Sqrt IS
  ...
  SIGNAL din_signed                       : signed(64 DOWNTO 0);  -- sfix65
...
BEGIN
  ...
  resizedin <= X"FFFFFFFF" WHEN (din_signed(64) = '0') AND (din_signed(63 DOWNTO 32) /= X"00000000") ELSE
      X"00000000" WHEN din_signed(64) = '1' ELSE
      unsigned(din_signed(31 DOWNTO 0));
