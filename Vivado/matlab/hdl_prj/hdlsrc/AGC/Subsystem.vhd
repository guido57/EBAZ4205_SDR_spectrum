-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj\hdlsrc\AGC\Subsystem.vhd
-- Created: 2022-12-17 21:16:32
-- 
...
ARCHITECTURE rtl OF Subsystem IS
  ...
  SIGNAL Gain_stage2_add_cast             : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL Gain_stage2_add_temp             : signed(16 DOWNTO 0);  -- sfix17
  SIGNAL Gain_op_stage1                   : signed(14 DOWNTO 0);  -- sfix15
  SIGNAL Gain_stage3_add_temp             : signed(16 DOWNTO 0);  -- sfix17
...
BEGIN
  ...
  Gain_stage2_add_cast <= signed(resize(Delay1_out1, 17));
  Gain_stage2_add_temp <= resize(Switch_out1, 17) + Gain_stage2_add_cast;
  
  Gain_op_stage1 <= "011111111111111" WHEN (Gain_stage2_add_temp(16) = '0') AND (Gain_stage2_add_temp(15 DOWNTO 14) /= "00") ELSE
      "100000000000000" WHEN (Gain_stage2_add_temp(16) = '1') AND (Gain_stage2_add_temp(15 DOWNTO 14) /= "11") ELSE
      Gain_stage2_add_temp(14 DOWNTO 0);

  Gain_stage3_add_temp <= resize(Gain_op_stage1, 17) + resize(Never_go_to_0_out1, 17);
  
  Gain_out1 <= "11111111111111" WHEN (Gain_stage3_add_temp(16) = '0') AND (Gain_stage3_add_temp(15 DOWNTO 14) /= "00") ELSE
      "00000000000000" WHEN Gain_stage3_add_temp(16) = '1' ELSE
