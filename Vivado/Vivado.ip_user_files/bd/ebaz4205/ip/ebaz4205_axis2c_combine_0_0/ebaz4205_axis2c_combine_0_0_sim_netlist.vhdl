...
-- Date        : Wed Apr 19 12:01:32 2023
-- Host        : guido-UM690 running 64-bit Ubuntu 20.04.6 LTS
-- Command     : write_vhdl -force -mode funcsim
--               /home/guido/GitHub/EBAZ4205_SDR_spectrum/Vivado/Vivado.gen/sources_1/bd/ebaz4205/ip/ebaz4205_axis2c_combine_0_0/ebaz4205_axis2c_combine_0_0_sim_netlist.vhdl
...
entity ebaz4205_axis2c_combine_0_0_axis2c_combine is
  port (
    tlast : out STD_LOGIC;
  ...
  attribute ORIG_REF_NAME of ebaz4205_axis2c_combine_0_0_axis2c_combine : entity is "axis2c_combine";
end ebaz4205_axis2c_combine_0_0_axis2c_combine;

architecture STRUCTURE of ebaz4205_axis2c_combine_0_0_axis2c_combine is
  ...
  attribute SOFT_HLUTNM of tlast_reg_i_1 : label is "soft_lutpair0";
begin
  tlast <= \^tlast\;
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity ebaz4205_axis2c_combine_0_0 is
  port (
    clk : in STD_LOGIC;
    aresetn : in STD_LOGIC;
    channel1_data : in STD_LOGIC_VECTOR ( 15 downto 0 );
  ...
  attribute NotValidForBitStream of ebaz4205_axis2c_combine_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of ebaz4205_axis2c_combine_0_0 : entity is "ebaz4205_axis2c_combine_0_0,axis2c_combine,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of ebaz4205_axis2c_combine_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of ebaz4205_axis2c_combine_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of ebaz4205_axis2c_combine_0_0 : entity is "axis2c_combine,Vivado 2022.2";
end ebaz4205_axis2c_combine_0_0;

architecture STRUCTURE of ebaz4205_axis2c_combine_0_0 is
  attribute X_INTERFACE_INFO : string;
  attribute X_INTERFACE_INFO of aresetn : signal is "xilinx.com:signal:reset:1.0 aresetn RST";
  attribute X_INTERFACE_PARAMETER : string;
  attribute X_INTERFACE_PARAMETER of aresetn : signal is "XIL_INTERFACENAME aresetn, POLARITY ACTIVE_LOW, INSERT_VIP 0";
  attribute X_INTERFACE_INFO of clk : signal is "xilinx.com:signal:clock:1.0 clk CLK";
  attribute X_INTERFACE_PARAMETER of clk : signal is "XIL_INTERFACENAME clk, ASSOCIATED_BUSIF interface_axis, ASSOCIATED_RESET aresetn, FREQ_HZ 128000000, FREQ_TOLERANCE_HZ 0, PHASE 0.0, CLK_DOMAIN /PS/clk_wiz_128M_clk_out1, INSERT_VIP 0";
  ...
  attribute X_INTERFACE_PARAMETER of tdata : signal is "XIL_INTERFACENAME interface_axis, TDATA_NUM_BYTES 2, TDEST_WIDTH 0, TID_WIDTH 0, TUSER_WIDTH 0, HAS_TREADY 1, HAS_TSTRB 0, HAS_TKEEP 0, HAS_TLAST 1, FREQ_HZ 128000000, PHASE 0.0, CLK_DOMAIN /PS/clk_wiz_128M_clk_out1, LAYERED_METADATA undef, INSERT_VIP 0";
begin
inst: entity work.ebaz4205_axis2c_combine_0_0_axis2c_combine
     port map (
      aresetn => aresetn,
