...
int XAxiVdma_ChannelConfig(mm_IP * _mm_IP, XAxiVdma_Channel *Channel,
        XAxiVdma_ChannelSetup *ChannelCfgPtr);
int XAxiVdma_ChannelSetBufferAddr(mm_IP * _mm_IP, XAxiVdma_Channel *Channel, UINTPTR *AddrSet,
        int NumFrames);
...
int XAxiVdma_ChannelSetFrmCnt(mm_IP * _mm_IP, XAxiVdma_Channel *Channel, u8 FrmCnt,
        u8 DlyCnt);
