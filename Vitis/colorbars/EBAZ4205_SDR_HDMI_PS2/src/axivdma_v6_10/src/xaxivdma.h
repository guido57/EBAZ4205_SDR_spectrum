...
u32 XAxiVdma_CurrFrameStore(mm_IP *, XAxiVdma *InstancePtr, u16 Direction);
u32 XAxiVdma_GetVersion(mm_IP *, XAxiVdma *InstancePtr);
u32 XAxiVdma_GetStatus(mm_IP *,XAxiVdma *InstancePtr, u16 Direction);
int XAxiVdma_SetLineBufThreshold(mm_IP *, XAxiVdma *InstancePtr, int LineBufThreshold,
	u16 Direction);
...
void XAxiVdma_IntrEnable(mm_IP * _mm_IP, XAxiVdma *InstancePtr, u32 IntrType, u16 Direction);
void XAxiVdma_IntrDisable(mm_IP * _mm_IP, XAxiVdma *InstancePtr, u32 IntrType ,u16 Direction);
u32 XAxiVdma_IntrGetPending(mm_IP * _mm_IP, XAxiVdma *InstancePtr, u16 Direction);
void XAxiVdma_IntrClear(mm_IP * _mm_IP, XAxiVdma *InstancePtr, u32 IntrType ,u16 Direction);

int XAxiVdma_SetBdAddrs(mm_IP *__mm_IP, XAxiVdma *InstancePtr, u32 BdAddrPhys, u32 BdAddrVirt,
         int NumBds, u16 Direction);

XAxiVdma_Channel *XAxiVdma_GetChannel(mm_IP * _mm_IP,XAxiVdma *InstancePtr, u16 Direction);
...
int XAxiVdma_ClearDmaChannelErrors(mm_IP * _mm_IP,XAxiVdma *InstancePtr, u16 Direction,
					u32 ErrorMask);
int XAxiVdma_MaskS2MMErrIntr(mm_IP * _mm_IP, XAxiVdma *InstancePtr, u32 ErrorMask,
                                        u16 Direction);
 ...
 */
void XAxiVdma_ReadIntrHandler(mm_IP * _mm_IP, void * InstancePtr);
void XAxiVdma_WriteIntrHandler(mm_IP * _mm_IP, void * InstancePtr);
int XAxiVdma_SetCallBack(mm_IP * _mm_IP, XAxiVdma * InstancePtr, u32 HandlerType,
