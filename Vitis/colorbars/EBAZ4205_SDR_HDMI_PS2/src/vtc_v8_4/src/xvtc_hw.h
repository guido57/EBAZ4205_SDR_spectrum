...
* @{
*/
//GG #define XVtc_In32		Xil_In32	/**< Input Operations */
//GG #define XVtc_Out32		Xil_Out32	/**< Output Operations */
...
*
******************************************************************************/
int XVtc_ReadReg(mm_IP *, int BaseAddress, int RegOffset );
/*****************************************************************************/
/**
*
...
******************************************************************************/
/*@}*/
void XVtc_WriteReg(mm_IP *, int BaseAddress, int RegOffset, int Data );
