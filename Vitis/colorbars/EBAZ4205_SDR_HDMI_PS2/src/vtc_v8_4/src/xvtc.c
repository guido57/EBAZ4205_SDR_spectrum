...
*
******************************************************************************/
int XVtc_CfgInitialize(mm_IP * _mm_IP, XVtc *InstancePtr, XVtc_Config *CfgPtr,
...
*
******************************************************************************/
void XVtc_EnableGenerator(mm_IP * _mm_IP, XVtc *InstancePtr)
{
	u32 CtrlRegValue;
	...
	CtrlRegValue = XVtc_ReadReg(_mm_IP, InstancePtr->Config.BaseAddress,
					(XVTC_CTL_OFFSET));

	/* Change the value according to the enabling type and write it back */
	CtrlRegValue |= XVTC_CTL_GE_MASK;

	XVtc_WriteReg(_mm_IP, InstancePtr->Config.BaseAddress, (XVTC_CTL_OFFSET),
			CtrlRegValue);
}
...
*
******************************************************************************/
void XVtc_EnableDetector(mm_IP * _mm_IP, XVtc *InstancePtr)
{
	u32 CtrlRegValue;
...
*
******************************************************************************/
void XVtc_Enable(mm_IP * _mm_IP, XVtc *InstancePtr)
{
	u32 CtrlRegValue;
...
*
******************************************************************************/
void XVtc_DisableGenerator(mm_IP * _mm_IP, XVtc *InstancePtr)
{
	u32 CtrlRegValue;
...
*
******************************************************************************/
void XVtc_DisableDetector(mm_IP * _mm_IP, XVtc *InstancePtr)
{
	u32 CtrlRegValue;
...
*
******************************************************************************/
void XVtc_Disable(mm_IP * _mm_IP, XVtc *InstancePtr)
{
	u32 CtrlRegValue;
...
*
*****************************************************************************/
void XVtc_SetPolarity(mm_IP * _mm_IP, XVtc *InstancePtr, XVtc_Polarity *PolarityPtr)
{
	u32 PolRegValue;
	 ...
	 * bits first
	 */
	PolRegValue = XVtc_ReadReg(_mm_IP, InstancePtr->Config.BaseAddress,
					(XVTC_GPOL_OFFSET));
	...
	XVtc_WriteReg(_mm_IP,InstancePtr->Config.BaseAddress, (XVTC_GPOL_OFFSET),
			PolRegValue);
}
...
*
******************************************************************************/
void XVtc_GetPolarity(mm_IP * _mm_IP, XVtc *InstancePtr, XVtc_Polarity *PolarityPtr)
{
	u32 PolRegValue;
...
*
******************************************************************************/
void XVtc_GetDetectorPolarity(mm_IP * _mm_IP, XVtc *InstancePtr, XVtc_Polarity *PolarityPtr)
{
	u32 PolRegValue;
...
*
******************************************************************************/
void XVtc_SetSource(mm_IP * _mm_IP, XVtc *InstancePtr, XVtc_SourceSelect *SourcePtr)
{
	u32 CtrlRegValue;
...
*
*****************************************************************************/
void XVtc_GetSource(mm_IP * _mm_IP, XVtc *InstancePtr, XVtc_SourceSelect *SourcePtr)
{
	u32 CtrlRegValue;
...
*
******************************************************************************/
void XVtc_SetSkipLine(mm_IP * _mm_IP, XVtc *InstancePtr, int GeneratorChromaSkip)
{
	...
	FrameEncodeRegValue = XVtc_ReadReg(_mm_IP, InstancePtr->Config.BaseAddress,
						(XVTC_GFENC_OFFSET));
	...
	XVtc_WriteReg(_mm_IP,InstancePtr->Config.BaseAddress, (XVTC_GFENC_OFFSET),
			FrameEncodeRegValue);
}
...
*
******************************************************************************/
void XVtc_GetSkipLine(mm_IP * _mm_IP, XVtc *InstancePtr, int *GeneratorChromaSkipPtr)
{
	u32 FrameEncodeRegValue;
...
*
******************************************************************************/
void XVtc_SetSkipPixel(mm_IP * _mm_IP, XVtc *InstancePtr, int GeneratorChromaSkip)
{
	u32 FrameEncodeRegValue;
...
*
******************************************************************************/
void XVtc_GetSkipPixel(mm_IP * _mm_IP, XVtc *InstancePtr, int *GeneratorChromaSkipPtr)
{
	u32 FrameEncodeRegValue;
...
*
******************************************************************************/
void XVtc_SetDelay(mm_IP * _mm_IP, XVtc *InstancePtr, int VertDelay, int HoriDelay)
{
	u32 RegValue;
	...
	XVtc_WriteReg(_mm_IP,InstancePtr->Config.BaseAddress, (XVTC_GGD_OFFSET),
			RegValue);
}
...
*
******************************************************************************/
void XVtc_GetDelay(mm_IP * _mm_IP, XVtc *InstancePtr, int *VertDelayPtr, int *HoriDelayPtr)
{
	u32 RegValue;
	...
	RegValue = XVtc_ReadReg(_mm_IP, InstancePtr->Config.BaseAddress,
				(XVTC_GGD_OFFSET));
...
*
******************************************************************************/
void XVtc_SetFSync(mm_IP * _mm_IP, XVtc *InstancePtr, u16 FrameSyncIndex, u16 VertStart,
			u16 HoriStart)
{
	u32 RegValue;
	u32 RegAddress;
	...
	/* Update the Generator Global Delay register w/ the value */
	XVtc_WriteReg(_mm_IP, InstancePtr->Config.BaseAddress, RegAddress, RegValue);
}
...
*
******************************************************************************/
void XVtc_GetFSync(mm_IP * _mm_IP, XVtc *InstancePtr, u16 FrameSyncIndex,
			u16 *VertStartPtr, u16 *HoriStartPtr)
{
	...
	RegValue = XVtc_ReadReg(_mm_IP,InstancePtr->Config.BaseAddress, RegAddress);
 ...
 *
 *****************************************************************************/
void XVtc_SetGeneratorHoriOffset(mm_IP * _mm_IP, XVtc *InstancePtr,
				XVtc_HoriOffsets *HoriOffsets)
{
	...
	XVtc_WriteReg(_mm_IP, InstancePtr->Config.BaseAddress, XVTC_GVBHOFF_OFFSET,
								RegValue);
	...
	RegValue |= (HoriOffsets->V0SyncHoriEnd << XVTC_XVXHOX_HEND_SHIFT) &
					XVTC_XVXHOX_HEND_MASK;
	XVtc_WriteReg(_mm_IP, InstancePtr->Config.BaseAddress, XVTC_GVSHOFF_OFFSET,
								RegValue);
	...
	RegValue |= (HoriOffsets->V1BlankHoriEnd << XVTC_XVXHOX_HEND_SHIFT) &
					XVTC_XVXHOX_HEND_MASK;
	XVtc_WriteReg(_mm_IP, InstancePtr->Config.BaseAddress, XVTC_GVBHOFF_F1_OFFSET,
								RegValue);
	...
	RegValue |= (HoriOffsets->V1SyncHoriEnd << XVTC_XVXHOX_HEND_SHIFT) &
					XVTC_XVXHOX_HEND_MASK;
	XVtc_WriteReg(_mm_IP, InstancePtr->Config.BaseAddress,
...
*
******************************************************************************/
void XVtc_GetGeneratorHoriOffset(mm_IP * _mm_IP, XVtc *InstancePtr,
					XVtc_HoriOffsets *HoriOffsets)
{
	u32 RegValue;
...
*
******************************************************************************/
void XVtc_GetDetectorHoriOffset(mm_IP * _mm_IP,XVtc *InstancePtr,
				XVtc_HoriOffsets *HoriOffsets)
{
	u32 RegValue;
...
*
*****************************************************************************/
void XVtc_SetGenerator(mm_IP * _mm_IP,  XVtc *InstancePtr, XVtc_Signal *SignalCfgPtr)
{
	u32 RegValue;
	...
	XVtc_SetGeneratorHoriOffset(_mm_IP, InstancePtr, &horiOffsets);
...
*
******************************************************************************/
void XVtc_GetGenerator(mm_IP * _mm_IP, XVtc *InstancePtr, XVtc_Signal *SignalCfgPtr)
{
	u32 RegValue;
  u32 r_htotal, r_vtotal, r_hactive, r_vactive;
	XVtc_Signal *SCPtr;
  ...
  if(SCPtr->OriginMode == 0)
  {
	...
	RegValue = XVtc_ReadReg(_mm_IP, InstancePtr->Config.BaseAddress, XVTC_GHSIZE_OFFSET);
	r_htotal = (RegValue) & XVTC_SB_START_MASK;
	SCPtr->HTotal = (r_htotal-1) & XVTC_SB_START_MASK;

	RegValue = XVtc_ReadReg(_mm_IP, InstancePtr->Config.BaseAddress, XVTC_GVSIZE_OFFSET);
	...
	RegValue = XVtc_ReadReg(_mm_IP, InstancePtr->Config.BaseAddress, XVTC_GASIZE_OFFSET);
	...
	RegValue = XVtc_ReadReg(_mm_IP, InstancePtr->Config.BaseAddress, XVTC_GHSYNC_OFFSET);
    SCPtr->HSyncStart = ((RegValue - r_hactive) & XVTC_SB_START_MASK);
    SCPtr->HBackPorchStart = (((RegValue>>16) - r_hactive) & XVTC_SB_START_MASK);

	RegValue = XVtc_ReadReg(_mm_IP, InstancePtr->Config.BaseAddress, XVTC_GVSYNC_OFFSET);
	...
	RegValue = XVtc_ReadReg(_mm_IP, InstancePtr->Config.BaseAddress, XVTC_GVSYNC_F1_OFFSET);
	...
	RegValue = XVtc_ReadReg(_mm_IP, InstancePtr->Config.BaseAddress, XVTC_GFENC_OFFSET);
...
*
******************************************************************************/
void XVtc_GetDetector(mm_IP * _mm_IP, XVtc *InstancePtr, XVtc_Signal *SignalCfgPtr)
{
	u32 RegValue;
	u32 r_htotal, r_vtotal, r_hactive, r_vactive;
	XVtc_Signal *SCPtr;
...
*
******************************************************************************/
u32 XVtc_GetVersion(mm_IP * _mm_IP, XVtc *InstancePtr)
{
	u32 Version;
	...
	Version = XVtc_ReadReg(_mm_IP, InstancePtr->Config.BaseAddress,
				XVTC_VER_OFFSET);
...
*
******************************************************************************/
void XVtc_ConvVideoMode2Timing(mm_IP * _mm_IP, XVtc *InstancePtr, u16 Mode,
...
*
******************************************************************************/
void XVtc_ConvTiming2Signal(mm_IP * _mm_IP, XVtc *InstancePtr, XVtc_Timing *TimingPtr,
...
*
******************************************************************************/
void XVtc_SetGeneratorTiming(mm_IP * _mm_IP, XVtc *InstancePtr, XVtc_Timing * TimingPtr)
{
	...
	XVtc_ConvTiming2Signal(_mm_IP, InstancePtr, TimingPtr, &Signal, &Hoff,
				&Polarity);
	XVtc_SetPolarity(_mm_IP, InstancePtr, &Polarity);
	XVtc_SetGenerator(_mm_IP, InstancePtr, &Signal);
	XVtc_SetGeneratorHoriOffset(_mm_IP, InstancePtr, &Hoff);
}
...
*
******************************************************************************/
void XVtc_SetGeneratorVideoMode(mm_IP * _mm_IP, XVtc *InstancePtr, u16 Mode)
{
	XVtc_Timing Timing;
	...
	XVtc_ConvVideoMode2Timing(_mm_IP, InstancePtr, Mode, &Timing);

	XVtc_SetGeneratorTiming(_mm_IP, InstancePtr, &Timing);
...
*
******************************************************************************/
void XVtc_GetGeneratorTiming(mm_IP *_mm_IP, XVtc *InstancePtr, XVtc_Timing *TimingPtr)
{
	...
	Signal.OriginMode = 1;
	XVtc_GetPolarity(_mm_IP, InstancePtr, &Polarity);
	XVtc_GetGeneratorHoriOffset(_mm_IP, InstancePtr, &Hoff);
	XVtc_GetGenerator(_mm_IP, InstancePtr, &Signal);
...
*
******************************************************************************/
u16 XVtc_GetGeneratorVideoMode(mm_IP * _mm_IP, XVtc *InstancePtr)
{
	...
	XVtc_GetGeneratorTiming(_mm_IP, InstancePtr, &Timing);
...
*
******************************************************************************/
void XVtc_GetDetectorTiming(mm_IP * _mm_IP, XVtc *InstancePtr, XVtc_Timing *TimingPtr)
{
	XVtc_Polarity Polarity;
	XVtc_Signal Signal;
	XVtc_HoriOffsets Hoff;
	...
	Signal.OriginMode = 1;
	XVtc_GetDetector(_mm_IP, InstancePtr, &Signal);
	XVtc_GetDetectorPolarity(_mm_IP,InstancePtr, &Polarity);
	XVtc_GetDetectorHoriOffset(_mm_IP,InstancePtr, &Hoff);
...
*
******************************************************************************/
u16 XVtc_GetDetectorVideoMode(mm_IP * _mm_IP,XVtc *InstancePtr)
{
	u16 mode;
	XVtc_Timing Timing;
	...
	XVtc_GetDetectorTiming(_mm_IP,InstancePtr, &Timing);
	mode = XVtc_ConvTiming2VideoMode(InstancePtr, &Timing);
 ...
 *
 ******************************************************************************/
void XVtc_SetAdaptiveSyncMode(mm_IP * _mm_IP,XVtc *InstancePtr, XVtc_AdaptiveSyncMode Mode)
{
	u32 RegValue;
	...
	if (Mode > XVTC_FIXED_MODE)
		...
		RegValue &= ~XVTC_ADAPTIVE_MODE_MASK;
	XVtc_WriteReg(_mm_IP,InstancePtr->Config.BaseAddress, XVTC_ADAPTIVE_CTL_OFFSET,
 ...
 *
 ******************************************************************************/
void XVtc_DisableAdaptiveSync(mm_IP * _mm_IP, XVtc *InstancePtr)
{
	u32 RegValue;
 ...
 *
 ******************************************************************************/
void XVtc_SetVfpStretchLimit(mm_IP * _mm_IP, XVtc *InstancePtr, u32 StretchLimit)
{
	/* Verify argument. */
	Xil_AssertVoid(InstancePtr);
	Xil_AssertVoid(InstancePtr->IsReady == XIL_COMPONENT_IS_READY);
