...
*
******************************************************************************/
#define XVtc_RegUpdateEnable(_mm_IP, InstancePtr) \
	XVtc_WriteReg(_mm_IP, (InstancePtr)->Config.BaseAddress, (XVTC_CTL_OFFSET), \
		XVtc_ReadReg(_mm_IP, (InstancePtr)->Config.BaseAddress, \
...
*
******************************************************************************/
#define XVtc_IntrGetPending(_mm_IP, InstancePtr) \
	(XVtc_ReadReg(_mm_IP,(InstancePtr)->Config.BaseAddress, XVTC_IER_OFFSET) & \
	 XVtc_ReadReg(_mm_IP,(InstancePtr)->Config.BaseAddress, XVTC_ISR_OFFSET) & \
	 XVTC_IXR_ALLINTR_MASK)
...
*
******************************************************************************/
#define XVtc_IntrClear(_mm_IP, InstancePtr, IntrType) \
	XVtc_WriteReg(_mm_IP, (InstancePtr)->Config.BaseAddress, (XVTC_ISR_OFFSET), \
		((IntrType) & (XVTC_IXR_ALLINTR_MASK)))
...
/* Initialization */
int XVtc_CfgInitialize(mm_IP *, XVtc *InstancePtr, XVtc_Config *CfgPtr,
			UINTPTR EffectiveAddr);

/* Enabling and Disabling the VTC core */
void XVtc_EnableGenerator(mm_IP * , XVtc *InstancePtr);
void XVtc_EnableDetector(mm_IP *, XVtc *InstancePtr);
void XVtc_Enable(mm_IP *, XVtc *InstancePtr);
void XVtc_DisableGenerator(mm_IP *, XVtc *InstancePtr);
void XVtc_DisableDetector(mm_IP *, XVtc *InstancePtr);
void XVtc_Disable(mm_IP *, XVtc *InstancePtr);

/* Video Mode, Timing and Signal/HoriOffsets/Polarity Conversions */
void XVtc_ConvVideoMode2Timing(mm_IP *, XVtc *InstancePtr, u16 Mode,
		XVtc_Timing *TimingPtr);
void XVtc_ConvTiming2Signal(mm_IP *, XVtc *InstancePtr, XVtc_Timing *TimingPtr,
...
void XVtc_SetGeneratorTiming(mm_IP *, XVtc *InstancePtr, XVtc_Timing * TimingPtr);
void XVtc_SetGeneratorVideoMode(mm_IP *, XVtc *InstancePtr, u16 Mode);
void XVtc_GetGeneratorTiming(mm_IP * , XVtc *InstancePtr, XVtc_Timing *TimingPtr);
u16  XVtc_GetGeneratorVideoMode(mm_IP *, XVtc *InstancePtr);
void XVtc_GetDetectorTiming(mm_IP *, XVtc *InstancePtr, XVtc_Timing *TimingPtr);
u16  XVtc_GetDetectorVideoMode(mm_IP *,XVtc *InstancePtr);

/* Polarity setting */
void XVtc_SetPolarity(mm_IP *, XVtc *InstancePtr, XVtc_Polarity *PolarityPtr);
void XVtc_GetPolarity(mm_IP *, XVtc *InstancePtr, XVtc_Polarity *PolarityPtr);
void XVtc_GetDetectorPolarity(mm_IP *, XVtc *InstancePtr, XVtc_Polarity *PolarityPtr);

/* Source selection */
void XVtc_SetSource(mm_IP *, XVtc *InstancePtr, XVtc_SourceSelect *SourcePtr);
void XVtc_GetSource(mm_IP *, XVtc *InstancePtr, XVtc_SourceSelect *SourcePtr);

/* Skipping setting */
void XVtc_SetSkipLine(mm_IP *, XVtc *InstancePtr, int GeneratorChromaSkip);
void XVtc_GetSkipLine(mm_IP *, XVtc *InstancePtr, int *GeneratorChromaSkipPtr);
void XVtc_SetSkipPixel(mm_IP *, XVtc *InstancePtr, int GeneratorChromaSkip);
void XVtc_GetSkipPixel(mm_IP *, XVtc *InstancePtr, int *GeneratorChromaSkipPtr);

/* VTC generator/detector setting/fetching */
void XVtc_SetGenerator(mm_IP *, XVtc *InstancePtr, XVtc_Signal *SignalCfgPtr);
void XVtc_GetGenerator(mm_IP *, XVtc *InstancePtr, XVtc_Signal *SignalCfgPtr);
void XVtc_GetDetector(mm_IP *, XVtc *InstancePtr, XVtc_Signal *SignalCfgPtr);

/* Delay setting */
void XVtc_SetDelay(mm_IP *, XVtc *InstancePtr, int VertDelay, int HoriDelay);
void XVtc_GetDelay(mm_IP *, XVtc *InstancePtr, int *VertDelayPtr, int *HoriDelayPtr);

/* Frame Sync setting */
void XVtc_SetFSync(mm_IP *, XVtc *InstancePtr, u16 FrameSyncIndex,
			   u16 VertStart, u16 HoriStart);
void XVtc_GetFSync(mm_IP *, XVtc *InstancePtr, u16 FrameSyncIndex,
			   u16 *VertStartPtr, u16 *HoriStartPtr);

/* Horizontal Offset Setting */
void XVtc_SetGeneratorHoriOffset(mm_IP *, XVtc *InstancePtr,
			   XVtc_HoriOffsets *HoriOffset);
void XVtc_GetGeneratorHoriOffset(mm_IP *, XVtc *InstancePtr,
			   XVtc_HoriOffsets *HoriOffset);
void XVtc_GetDetectorHoriOffset(mm_IP *, XVtc *InstancePtr,
			   XVtc_HoriOffsets *HoriOffset);

/* Version function */
u32 XVtc_GetVersion(mm_IP *, XVtc *InstancePtr);
 ...
 */
void XVtc_IntrHandler(mm_IP *,void *InstancePtr);
int XVtc_SetCallBack(XVtc *InstancePtr, u32 IntrType,
			void *CallBackFunc, void *CallBackRef);

/* SelfTest related function in xvtc_selftest.c */
int XVtc_SelfTest(mm_IP *, XVtc *InstancePtr);

/* Adaptive-Sync related functions */
void XVtc_SetAdaptiveSyncMode(mm_IP *,XVtc *InstancePtr, XVtc_AdaptiveSyncMode Mode);
void XVtc_DisableAdaptiveSync(mm_IP *, XVtc *InstancePtr);
void XVtc_SetVfpStretchLimit(mm_IP *,XVtc *InstancePtr, u32 StretchLimit);
