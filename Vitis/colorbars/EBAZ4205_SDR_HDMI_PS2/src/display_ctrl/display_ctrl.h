...
int DisplayStart(mm_IP * vtc_mm_IP, mm_IP * vdma_mm_IP,mm_IP * dynclk_mm_IP, DisplayCtrl *dispPtr);
...
int DisplayChangeFrame(mm_IP *, DisplayCtrl *dispPtr, u32 frameIndex);
