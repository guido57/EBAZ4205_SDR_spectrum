...
*
******************************************************************************/
s32 XScuTimer_SelfTest(mm_IP * _mm_IP, XScuTimer *InstancePtr)
{
	u32 Register;
	u32 CtrlOrig;
	u32 LoadOrig;
	 ...
	 */
	CtrlOrig = XScuTimer_ReadReg(_mm_IP,InstancePtr->Config.BaseAddr,
	 ...
	 */
	LoadOrig = XScuTimer_ReadReg(_mm_IP,(InstancePtr)->Config.BaseAddr,
				  XSCUTIMER_LOAD_OFFSET);
	XScuTimer_LoadTimer(_mm_IP,InstancePtr, XSCUTIMER_SELFTEST_VALUE);
	 ...
	 */
	XScuTimer_LoadTimer(_mm_IP,InstancePtr, LoadOrig);
	XScuTimer_WriteReg(_mm_IP,InstancePtr->Config.BaseAddr,
