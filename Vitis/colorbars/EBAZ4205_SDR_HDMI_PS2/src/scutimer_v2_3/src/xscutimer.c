...
*
******************************************************************************/
void XScuTimer_Start(mm_IP * _mm_IP, XScuTimer *InstancePtr)
{
	u32 Register;
	 ...
	 */
	Register = XScuTimer_ReadReg(_mm_IP, InstancePtr->Config.BaseAddr,
...
*
******************************************************************************/
void XScuTimer_Stop(mm_IP * _mm_IP, XScuTimer *InstancePtr)
{
	u32 Register;
...
*
****************************************************************************/
void XScuTimer_SetPrescaler(mm_IP * _mm_IP, XScuTimer *InstancePtr, u8 PrescalerValue)
{
	u32 ControlReg;
	 ...
	 */
	ControlReg = XScuTimer_ReadReg(_mm_IP, InstancePtr->Config.BaseAddr,
					XSCUTIMER_CONTROL_OFFSET);
...
*
****************************************************************************/
u8 XScuTimer_GetPrescaler(mm_IP * _mm_IP, XScuTimer *InstancePtr)
{
	u32 ControlReg;
