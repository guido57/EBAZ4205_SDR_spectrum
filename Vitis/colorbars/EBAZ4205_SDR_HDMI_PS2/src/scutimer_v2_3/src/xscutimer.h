...
*
******************************************************************************/
#define XScuTimer_LoadTimer(_mm_IP, InstancePtr, Value)				\
	XScuTimer_WriteReg(_mm_IP, (InstancePtr)->Config.BaseAddr,		\
...
#define XScuTimer_GetCounterValue(InstancePtr)				\
	XScuTimer_ReadReg(_mm_IP, (InstancePtr)->Config.BaseAddr,		\
...
*
******************************************************************************/
#define XScuTimer_DisableAutoReload(_mm_IP, InstancePtr)			\
	XScuTimer_WriteReg(_mm_IP, (InstancePtr)->Config.BaseAddr,		\
			XSCUTIMER_CONTROL_OFFSET,			\
			(XScuTimer_ReadReg(_mm_IP, (InstancePtr)->Config.BaseAddr, \
				XSCUTIMER_CONTROL_OFFSET) &		\
 ...
 */
s32 XScuTimer_SelfTest(mm_IP *, XScuTimer *InstancePtr);
...
void XScuTimer_Start(mm_IP *, XScuTimer *InstancePtr);
void XScuTimer_Stop(mm_IP *, XScuTimer *InstancePtr);
void XScuTimer_SetPrescaler(mm_IP *, XScuTimer *InstancePtr, u8 PrescalerValue);
u8 XScuTimer_GetPrescaler(mm_IP *, XScuTimer *InstancePtr);
